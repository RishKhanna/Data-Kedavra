...
CREATE TABLE `author` (
  `id` int NOT NULL,
  `languages` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `designer` (
  `id` int NOT NULL,
  `softwaress` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `draws` (
  `cartoon` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `designer_id` int DEFAULT NULL,
  PRIMARY KEY (`cartoon`),
  KEY `designer_id` (`designer_id`),
...
CREATE TABLE `editor` (
  `id` int NOT NULL,
  `genres` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `marketing` (
  `id` int NOT NULL,
  `platforms` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `marketing` VALUES (401,'Facebook'),(402,'Instagram');
...
CREATE TABLE `Members` (
  ...
  `m_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `selling_advert` VALUES (901,401),(902,402),(903,402);
...
CREATE TABLE `Sponsors` (
  `sponsor_id` int NOT NULL,
  `product` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `payment` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `Sponsors` VALUES (901,'Beauty products','Credit'),(902,'EdTech','Net Banking'),(903,'MedTech','Credit');
...
CREATE TABLE `subscribes` (
  `volume` int NOT NULL,
  `issue` int NOT NULL,
  `subscriber` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
-- Dump completed on 2020-10-08 19:29:51
