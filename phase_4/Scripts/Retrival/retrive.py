...
def main():
	print(colored("Which of the following Retrivals would you like to perform?", 'cyan', attrs=['bold']))
	...
	if ch==1:
		print(colored("Which of the following Selections would you like to perform?",'cyan', attrs=['bold']), end='')
		print(colored("""
			1. List all Issues.
			2. List all Articles.
			3. List all Authors.
		...
		print(colored("Which of the following Projections would you like to perform?",'cyan', attrs=['bold']), end='')
		print(colored("""
		...
		print(colored("Which of the following Aggregates would you like to perform?", 'cyan', attrs=['bold']), end='')
		print(colored("""
		...
		print(colored("Which of the following Searches would you like to perform?", 'cyan', attrs=['bold']), end='')
		print(colored("""
		...
		print(colored("Which of the following Analysis would you like to perform?", 'cyan', attrs=['bold']), end='')
		print(colored("""
