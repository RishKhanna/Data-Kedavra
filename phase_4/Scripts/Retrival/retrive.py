...
def main(username, password):
	print(colored("Which of the following Retrivals would you like to perform?",
				  'blue', attrs=['bold']))
	print(colored("1. Selection", 'cyan', attrs=['bold']))
	print(colored("""
		List all Issues.
		List all Articles.
		List all Authors.
	...
	print(colored("2. Projection", 'cyan', attrs=['bold']))
	print(colored("""
		Issues in a Volume.
	...
	print(colored("3. Aggregate", 'cyan', attrs=['bold']))
	print(colored("""
	...
	print(colored("4. Search", 'cyan', attrs=['bold']))
	print(colored("""
		Search Articles by name.
		Search Members by name""", 'yellow'))
	print(colored("5. Analysis", 'cyan', attrs=['bold']))
	print(colored("""
